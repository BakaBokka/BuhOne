...
function Header() {
  ...
  const burgerClass = [{ Header__burger_show: isVisible === true }];
  const handleClick = () => {
      ...
      <div className="Header__content">
        ...
        <nav className="Header__nav ">
          <ul className="Header__contacts">
            ...
            <li className="Header__contacts-item">
              <a
                href="https://yandex.ru/maps/-/CCUArAar2B"
                className="Header__contacts-link"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <nav className={classNames("Header__burger", burgerClass)}>
          <ul className="Header__burger-menu">
            <li className="Header__burger-menu-item">
              <a href="#anc1" className="Header__burger-menu-link">
                Главная
              </a>
            </li>
            <li className="Header__burger-menu-item">
              <a href="#anc2" className="Header__burger-menu-link">
                услуги
              </a>
            </li>
            <li className="Header__burger-menu-item">
              <a href="#anc3" className="Header__burger-menu-link">
                кейсы
              </a>
            </li>
            <li className="Header__burger-menu-item">
              <a href="#anc4" className="Header__burger-menu-link">
                о компании
              </a>
            </li>
            <li className="Header__burger-menu-item">
              <a href="#anc5" className="Header__burger-menu-link">
                контакты
              </a>
            </li>
          </ul>
