          ...
          <ul className="Contacts__list">
            <li className="Contacts__list-item">
              <a href="tel:+71112223344" className="Contacts__list-link">
                <img src={phone} alt="Иконка телефона" className="Contacts__list-ico" /> +7 (111) 222-33-44
              </a>
            </li>
            <li className="Contacts__list-item">
              <a href="mailto:order@bu-one.ru" className="Contacts__list-link">
                <img src={mail} alt="Иконка email" className="Contacts__list-ico" /> order@bu-one.ru
              </a>
            </li>
          </ul>
          </div>
